...
const FISH_MODELS = [
    ...
    // 🐟 일반 물고기
    // ======================
    //{ url: "./models/fish.glb", weight: 10, speed: 0.30, turnSpeed: 0.2, scale: 1.5, hp: 15, score: 10, type: "normal" },
    { url: "./models/fish2.glb", weight: 40, speed: 0.050, turnSpeed: 0.08, scale: 0.25, hp: 10, score: 20, type: "normal" },
    { url: "./models/fish3.glb", weight: 10, speed: 0.050, turnSpeed: 0.03, scale: 0.05, hp: 5, score: 10, type: "normal" },
    //{ url: "./models/fish4.glb", weight: 10, speed: 0.025, turnSpeed: 0.03, scale: 0.3, hp: 5, score: 5, type: "normal" },
    { url: "./models/fish5.glb", weight: 10, speed: 0.050, turnSpeed: 0.08, scale: 0.35, hp: 10, score: 20, type: "normal" },
    //{ url: "./models/fish6.glb", weight: 10, speed: 0.050, turnSpeed: 0.08, scale: 0.15, hp: 15, score: 10, type: "normal" },
    { url: "./models/fish7.glb", weight: 10, speed: 0.050, turnSpeed: 0.08, scale: 0.30, hp: 5, score: 10, type: "normal" },
    { url: "./models/fish8.glb", weight: 10, speed: 0.050, turnSpeed: 0.08, scale: 0.03, hp: 5, score: 10, type: "normal" }, 
    ...
    { url: "./models/fish12.glb", weight: 10, speed: 0.05, turnSpeed: 0.03, scale: 0.5, hp: 15, score: 50, type: "normal" },
    ...
    // 🦈🐋🐢 이벤트 물고기 (통합됨)
    // ======================
    { url: "./models/turtle.glb", weight: 0.2, speed: 0.05, turnSpeed: 0.03, scale: 0.010, hp: 70, score: 1000, spawnBonus: 500, type: "turtle" },
    { url: "./models/shark.glb", weight: 0.1, speed: 0.08, turnSpeed: 0.03, scale: 5, hp: 100, score: 3000, spawnBonus: 500, type: "shark" },
...
function animate() {
    ...
    else if (rr < 0.90) startSharkEvent();   ////////////////////////////////// 15%  상어 나올 확률
